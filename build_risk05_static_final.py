...
risk_compare = "".join([
    ...
    mini("MaxDD 0.5%", fmt(max_dd)+"%", "текущий риск", "green"),
...
<div class="app">
<aside>
<div class="brand"><div class="logo">T</div><div><h1>TrendFrend</h1><p>Risk 0.5 Final</p></div></div>
...
<div class="side-card"><div class="label">Сравнение</div><h3>DD снижена ×2</h3><p>1.0% risk: <b>26.04%</b></p><p>0.5% risk: <b>{fmt(max_dd)}%</b></p></div>
</aside>
<main>
<div class="top"><div class="title"><h2>TrendFrend <span class="badge">RISK 0.5% FINAL</span></h2><p>Monthly Fixed-Return Compounding • данные только из out_risk_05pct_monthly</p></div><div class="pill">СТАТИЧЕСКАЯ АНАЛИТИКА</div></div>
...
<div class="card"><div class="section"><h3>Помесячная сводка</h3><span>Risk 0.5%</span></div><div class="mini-grid">{month_summary}</div></div>
...
(OUT / "risk05-final.html").write_text(html, encoding="utf-8")
print("built:", OUT / "risk05-final.html")
